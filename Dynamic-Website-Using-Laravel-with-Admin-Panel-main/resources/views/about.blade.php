...
<head>
    ...
    <title>Rumah Tahanan Kelas IIB Situbondo - Profil Sederhana & Statistik</title>
    ...
    <header class="hero text-white py-16 md:py-24">
        <div class="max-w-6xl mx-auto px-4 text-center">
            ...
            <h1 class="text-5xl md:text-6xl font-extrabold mb-4 leading-tight">
                Rumah Tahanan Negara Kelas IIB Situbondo
            </h1>
            ...
            <div id="quick-stats" class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12 max-w-5xl mx-auto">
                ...
                <div class="stat-card">
                    <!-- Data Target: 100 -->
                    <div class="count-number text-4xl font-extrabold text-red-600" data-target="200">0</div>
                ...
                <div class="stat-card">
                    <!-- Data Target: 35 -->
                    <div class="count-number text-4xl font-extrabold text-green-600" data-target="67">0</div>
