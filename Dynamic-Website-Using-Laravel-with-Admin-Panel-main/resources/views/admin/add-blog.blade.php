          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add New Berita</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Title of New Berita</label>
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Short Details of New Berita</label>
                   ...
                   <div class="form-group">
                    <label for="exampleInputPassword1">Full Details of New Berita</label>
                    <textarea rows="10" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Full Details of New Blog" name="f_details" maxlength="10000" required></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Add Image of New Berita</label>
