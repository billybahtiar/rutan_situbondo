          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Kegiatan Ini</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Edit Nama Kegiatan</label>
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Select New Image</label>
